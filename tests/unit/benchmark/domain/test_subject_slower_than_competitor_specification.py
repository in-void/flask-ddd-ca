...
specification = SubjectLoadedSlowerThanAtLeastOneOfCompetitorsSpecification()


def test_it_should_return_true_if_subject_url_loaded_slower_than_at_least_one_of_competitors():
    # given
